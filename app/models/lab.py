...
class LabTest(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "panel_thickness > 0", name="ck_lab_tests_panel_thickness_positive"
        ),
        CheckConstraint(
            "actual_thickness > 0", name="ck_lab_tests_actual_thickness_positive"
        ),
        CheckConstraint(
            "calculated_density >= 0",
            name="ck_lab_tests_calculated_density_nonnegative",
        ),
        CheckConstraint(
            "moisture_content >= 0", name="ck_lab_tests_moisture_content_nonnegative"
        ),
        CheckConstraint(
            "internal_bond >= 0", name="ck_lab_tests_internal_bond_nonnegative"
        ),
        CheckConstraint(
            "bending_strength >= 0", name="ck_lab_tests_bending_strength_nonnegative"
        ),
        CheckConstraint(
            "elastic_modulus >= 0", name="ck_lab_tests_elastic_modulus_nonnegative"
        ),
        CheckConstraint(
            "thickness_swelling >= 0",
            name="ck_lab_tests_thickness_swelling_nonnegative",
        ),
        CheckConstraint(
            "water_absorption >= 0", name="ck_lab_tests_water_absorption_nonnegative"
        ),
        CheckConstraint(
            "formaldehyde_emission >= 0",
            name="ck_lab_tests_formaldehyde_emission_nonnegative",
        ),
        CheckConstraint(
            "formaldehyde_content >= 0",
            name="ck_lab_tests_formaldehyde_content_nonnegative",
        ),
    )
