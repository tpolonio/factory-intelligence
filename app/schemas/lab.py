...
class LabTestCreate(BaseModel):
    ...
    calculated_density: Decimal = Field(max_digits=6, decimal_places=2, ge=0)
    ...
    elastic_modulus: Decimal = Field(max_digits=6, decimal_places=2, ge=0)
...
class LabTestRead(BaseModel):
    ...
    shift_id: int = Field(gt=0)
    panel_type: PanelType
    panel_thickness: Decimal = Field(max_digits=6, decimal_places=2, ge=0)
    actual_thickness: Decimal = Field(max_digits=6, decimal_places=2, ge=0)
    calculated_density: Decimal = Field(max_digits=6, decimal_places=2, ge=0)
    moisture_content: Decimal = Field(max_digits=6, decimal_places=2, ge=0)
    internal_bond: Decimal = Field(max_digits=6, decimal_places=2, ge=0)
    bending_strength: Decimal = Field(max_digits=6, decimal_places=2, ge=0)
